...
const HomePage = () => {
  ...
  return (
    <div className="grid h-screen max-w-[73.75rem] grid-rows-[auto_minmax(375px,_1fr)] md:grid-rows-[auto_auto_minmax(375px,_1fr)] md:gap-10 md:px-10 md:pt-14 lg:mx-auto lg:grid-cols-[15.9375rem_minmax(0,_1fr)] lg:grid-rows-[min-content_auto] lg:gap-[1.875rem]">
